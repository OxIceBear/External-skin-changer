        ...
        if (GameState == clientState.ingame)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                else if (weaponID == WEAPON_AUG)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Mihajlo Kemper mrtvi!");
                }
                ...
                else if (weaponID == WEAPON_MP9)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Brankeza umire od ovoga!");
                }
                else if (weaponID == WEAPON_REVOLVER)
                {
                    Paintkit = 1145;
                    Seed = 420;
                    Statrak = 69;
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "ZA NJEGOSA OD KRAJINE!");
                }
                ...
                else if (weaponID == WEAPON_DEAGLE)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Printstream, i love it!!");
                }
                ...
                else if (weaponID == WEAPON_M4A1_SILENCER)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Hyper, a to je peder");
                }
                else if (weaponID == WEAPON_AK47)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Zdravko colic!");
                }
                else if (weaponID == WEAPON_DEAGLE)
                {
                    Paintkit = 603;
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Deagle to the win");
                }
                else if (weaponID == WEAPON_GLOCK)
                {
                    ...
                    Quality = 3;
                    Wear = 0.0003f;
                    strcpy(CustomName, "Glock Starter");
                }
                ...
                Quality = 3;
                Wear = 0.0003f;
                strcpy(CustomName, "Karambit svako voli");
