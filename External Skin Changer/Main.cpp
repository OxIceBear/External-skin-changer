...
void createAscii()
{
    ...
    std::cout << R"(
                           ...
                           Hi, This is a skin changer, it works also and gives u knife, updated version!!!!     
)" << '\n';
}
...
int main()
{
    ...
    */
    ...
    if (hwnd && processID)
    {
        consoleMsg("Succesfully Injected... You can press the F9 button to update skins, coded By OxIceBear.");
    }
    ...
    std::thread otherThreads(skinChanger);
    skinChanger();
}